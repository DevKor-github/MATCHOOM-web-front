      ...
      <BottomSheetPortal>
        <div className='fixed bottom-0 left-0 right-0 top-0 z-[100] hidden bg-black/50'>
          <div
            ref={ref}
            role='dialog'
            className='fixed -bottom-60 left-0 right-0 mx-auto hidden max-h-[90dvh] min-h-100 w-full max-w-500 -translate-x-1/2 flex-col rounded-t-[20px] bg-grey-7 px-32 pb-60 transition-transform duration-0 ease-out'
          >
